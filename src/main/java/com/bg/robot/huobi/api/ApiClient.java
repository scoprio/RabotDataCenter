...
import com.bg.robot.huobi.request.CreateOrderRequest;
import com.bg.robot.huobi.request.DepthRequest;
import com.bg.robot.huobi.request.IntrustOrdersDetailRequest;
import com.bg.robot.huobi.response.*;
